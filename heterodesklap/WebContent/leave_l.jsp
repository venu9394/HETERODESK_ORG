...
@keyframes spin {
 ...
 <script type="text/javascript">
  ...
  var MANAGERNAME= "<%=EMAILDATA.get("MANAGERNAME")%>";
  ...
  function Dpicker(){
	 ...
	 // $("#from").datepicker('option', 'maxDate', '2018-01-04' );
	  ...
	  $( function() {
		...
		if(SelectedLeaveType!="LOP" && SelectedLeaveType!="OD" && SelectedLeaveType!="WFH"){
...
<script>
  ...
  function GetLoadData(val){
	  ...
	  var SelectedLeaveType1=$("#Leave_Type option:selected ").text();
	  
	  if(val.value=="Select"){
	      $("#subject").val("Request For Leave") ;
	  }else{
		  $("#subject").val("Request For " +SelectedLeaveType1) ;  
	  }
...
For any information or queries, reach out to your HR.</B></li>
								...
								<a href="#" title='<%=EMAILDATA.get("MNGEMAIL")%>' > <%=EMAILDATA.get("MANAGERNAME")%>  </a>  
														...
														<input type="email" class="form-control" name="toemail" id="tags"  value='<%=EMAILDATA.get("MNGEMAIL")%>' style='display:none;' readonly  placeholder="someone@example.com">
													</div>
												</div>
												<div class="form-group" style='display:none;'>
													...
													<div class="col-md-8">
													    Business Unit HR
														<input type="email" class="form-control" name="ccemail" id="tags1"  style='display:none;'  readonly placeholder="someone@example.com">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-4 control-label">Subject</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="subject" value="Request For Leave" id="subject" placeholder="Subject" readOnly />
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
												<button type="button"  id="Send_Button" class="btn btn-primary align-right" onclick="Leave_Validation();" tabindex="-1" >Send</button>
												</div>
 ...
 if(from_date.length<4){
   ...
   /*  if((From_location.trim()).length==0 || (To_location.trim()).length==0){ */
      ...
      /* } */
	   ...
	   document.getElementById("Responce_Message").innerHTML="Please enter reason for leave (Length should be >5) ";
	   	return false; 
   ...
   if(reason.length>4 && to_mail.length>4){
	   ...
	   document.getElementById("Responce_Message").innerHTML="Please check To mail & reason for leave  (Reason for Leave leangth should be > 5) ";
   }
}
