  ...
  exports.dialog = function(options) {
    ...
    each(buttons, function(key, button) {
      ...
      // can just become a template too
    	//alert(key+"~~"+button) cancel;
     if(key=="cancel" || key=="Cancel" ){
      buttonStr += "<button data-bb-handler='" + key + "' type='button' style='display:none;' class='btn " + button.className + "'>" + button.label + "</button>";
     }else{
