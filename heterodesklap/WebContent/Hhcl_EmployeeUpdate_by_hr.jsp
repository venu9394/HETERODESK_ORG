 ...
 <script>
      function openColorBox(){
             ...
             // $.colorbox({iframe:true, width:"95%", height:"85%", href:"leave_l.jsp"});
    		  $.colorbox({iframe:true, width:"95%", height:"85%", href:"leave_2_temp.html"});
								...
								<ul class="nav nav-main">
								 ...
								 <li class="active">
									...
									<li  style='display:{{ HR_LINKS.LINK4 }}' >
									  <a href="ManagerApprovals?Routing=Dept_att_HR" target="_parent">
										<i class="fa fa-users" ></i>
										<span class="font-bold">BusinessUnit.Attendance2</span>
									  </a>
									</li> 
									 ...
									 <li  style='display:{{ HR_LINKS.LINK5 }}' >
									  <a href="##" target="_parent" onclick='openColorBox();' >
										<i class="fa fa-users" ></i>
										<span class="font-bold">Apply Manual Leave</span>
									  </a>
									</li> 
